...
<head>
    ...
    <title>Register Form | Kedang Murung</title>
    <link
      rel="icon"
    ...
    <div class="container-regis" >
        ...
        <div class="form" >
            ...
            <form  method="post"  autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="ikons">
                    <i class="fa-solid fa-lock icon-s"></i>
                ...
                <input type="hidden" name="tanggalBuat" >                
                ...
                <input type="submit" name="registrasi" class="submit" value="REGISTER "><br><br>
            </form>
